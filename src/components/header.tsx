    ...
    <header className="lg:sticky lg:top-0 lg:flex lg:max-h-screen lg:w-1/2 lg:flex-col lg:justify-between lg:py-24">
      <div className="flex flex-col items-start space-y-2">
        <h1 className="text-4xl font-bold tracking-tight text-slate-200 sm:text-5xl">
          Victor Yoshio Tanaka
        </h1>
        <h2 className="mt-3 text-lg font-medium tracking-tight text-slate-200 sm:text-xl">
          Desenvolvedor Junior Front-end
        </h2>
        <p className="mt-4 max-w-xs leading-normal text-customGray">
          Eu crio experiências intuitivas e soluções criativas.
        </p>
      </div>
      ...
      <ul className="ml-1 mt-8 flex items-center" aria-label="Social media">
        <li className="mr-5 text-xs shrink-0">
          <a
            ...
            href="https://github.com/vyoshio71"
            target="_blank"
        ...
        <li className="mr-5 text-xs shrink-0">
          <a
            className="block text-slate-400 hover:text-slate-200"
            href="https://instagram.com/victor.yoshio"
            target="_blank"
            rel="noreferrer noopener"
